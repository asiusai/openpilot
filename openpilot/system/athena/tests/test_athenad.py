...
class TestAthenadMethods(OpenpilotTestCase):
  ...
  def test_list_data_directory(self):
    ...
    filenames = ['qlog.zst', 'qcamera.mp4', 'rlog.zst', 'fcamera.mp4', 'ecamera.mp4', 'dcamera.mp4']
  ...
  def test_video_clip_hardware_encoder(self, mocker):
    clip = athenad.VideoClips.Clip("route", "fcamera.mp4", 10, 130, 2, 4, "clip.mp4", 123)
  ...
  def test_video_clip_hardware_encoder_failure(self, mocker):
    clip = athenad.VideoClips.Clip("route", "fcamera.mp4", 0, 60, 1, 1, "clip.mp4", 123)
    clips = self._video_clips(clip)
  ...
  def test_video_clip_software_fallback(self, mocker):
    clip = athenad.VideoClips.Clip("route", "fcamera.mp4", 10, 30, 3, 2, "clip.mp4", 123)
    clips = self._video_clips(clip)
    stdin = mocker.Mock()

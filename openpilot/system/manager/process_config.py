...
from openpilot.common.hardware import ASIUS_HARDWARE, PC, COMMA_HARDWARE
...
procs = [
  ...
  *camera_processes,
  ...
  PythonProcess("feedbackd", "openpilot.selfdrive.ui.feedback.feedbackd", only_onroad, enabled=not ASIUS_HARDWARE),

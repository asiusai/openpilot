...
class ModelState:
  ...
  def __init__(self, cam_w: int, cam_h: int):
    ...
    self._uploaded_frame = Tensor.empty(self.frame_buf_params[3], dtype='uint8', device=self.DEV).realize() if self.DEV.startswith("CL") else None
...
def main():
  ...
  sm = SubMaster(["liveCalibration", "modelV2"])
